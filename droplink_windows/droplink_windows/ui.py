...
class DropLinkApp(ctk.CTk):
    ...
    def _build(self) -> None:
        ...
        self.status.grid(row=2, column=0, padx=24, pady=(0, 16), sticky="ew")
    ...
    def transfer_progress(self, transfer_id: str, received: int, total: int) -> None:
        self.after(0, lambda: self.status.configure(text=f"Receiving {transfer_id[:8]}... {received / (1024 * 1024):.2f} MB"))
